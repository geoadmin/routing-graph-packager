...
from routing_packager_app.api_v1.dependencies import split_bbox, get_validated_name, validate_bbox


@pytest.mark.parametrize("bbox", ("0;0;1;1", "0,2,3"))
...
@pytest.mark.parametrize("bbox", ("20,20,20,20", "20,30,40,30", "120,50,110,60"))
def test_validate_bbox_fail(bbox):
    with pytest.raises(HTTPException) as e:
        validate_bbox(bbox)
    assert e.value.status_code == HTTP_400_BAD_REQUEST
